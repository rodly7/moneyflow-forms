  ...
  const handleAction = useMemo(() => (action: string) => {
    switch (action) {
      ...
      case 'transactions':
        ...
        break;
      case 'whatsapp':
        window.open('https://chat.whatsapp.com/KsyikhUdkTy7RbgVuyWSLu?mode=ac_c', '_blank');
        break;
      case 'bill-payments':
      ...
      <div className="p-3 sm:p-5 space-y-5 sm:space-y-7 pb-20 max-w-full">
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-5 max-w-full">
          {[
            ...
            { key: 'whatsapp', icon: null, label: 'WhatsApp', colors: 'from-green-500 to-lime-500', bg: 'from-green-600 to-lime-600' },
